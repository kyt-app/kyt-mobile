                          ...
                          children: <Widget>[
                            ...
                            TextFormField(
                              ...
                              validator: (String email) {
                                ...
                                return !emailRegex.hasMatch(email) ? 'Invalid email' : null;
                              },
                            ...
                            //     ),
                            //   ),
                            //   validator: (String country) { return country.isEmpty ? 'Country is required' : null; },
                            //   onSaved: (String country) { userCountry = country; },
                            // ),
                            DropdownButton(
                              value: userCountry,
                              ...
                              onChanged: (country) { userCountry = country; },
                            ),
                            MySpaces.vGapInBetween,
                            TextFormField(
                              decoration: InputDecoration(
                              ...
                              // FIXME: look into this regex and the expected input
                              validator: (String passport) {
                                if (userCountry == 'India') {
                                  RegExp indianPassport = RegExp(r"^[A-PR-WYa-pr-wy][1-9]\\d\\s?\\d{4}[1-9]$");
                                  return !indianPassport.hasMatch(passport) ? 'Invalid passport number' : null;
                                } else {
                                  RegExp usPassport = RegExp(r"^(?!(0))[a-zA-Z0-9]{6,9}$");
                                  return !usPassport.hasMatch(passport) ? 'Invalid passport number' : null;
                                }
                              },
                            ...
                            TextFormField(
                              ...
                              validator: (String password) {
                                return password.isEmpty ? 'Password is required' : null;
                              },
